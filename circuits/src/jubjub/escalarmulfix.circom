...
*/
// Ported from: circomlib/circuits/escalarmulfix.circom (circomlib v2.0.5,
// vendored in circuits/node_modules/circomlib).
// Changes from the original:
//   - include paths updated for the new circuits/src/jubjub/ layout: local
//     montgomery.circom and jubjub.circom (formerly babyjub.circom), plus
//     circomlib's mux3.circom via a relative path into node_modules.
//   - BabyAdd (from babyjub.circom) renamed to JubjubAdd (from jubjub.circom).
//   - No curve-constant literals live in this file directly; it inherits
//     Jubjub's a/d through MontgomeryAdd/MontgomeryDouble/JubjubAdd.
